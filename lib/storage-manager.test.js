...
describe('Storage Manager', () => {
  ...
  describe('saveCredentials', () => {
    ...
    it('should save Bedrock credentials with encryption', async () => {
      ...
      expect(credentialsCall[0].llm_credentials).toHaveProperty('provider', 'bedrock');
      expect(credentialsCall[0].llm_credentials).toHaveProperty('credentials');
    });
    ...
    it('should save Gemini credentials successfully', async () => {
      ...
      expect(credentialsCall).toBeDefined();
      expect(credentialsCall[0].llm_credentials).toHaveProperty('provider', 'gemini');
      expect(credentialsCall[0].llm_credentials).toHaveProperty('credentials');
    });
    ...
    it('should save Local LLM credentials successfully', async () => {
      ...
      expect(credentialsCall).toBeDefined();
      expect(credentialsCall[0].llm_credentials).toHaveProperty('provider', 'local');
      expect(credentialsCall[0].llm_credentials).toHaveProperty('credentials');
    });
  ...
  describe.skip('Security: Credential Encryption', () => {
    beforeEach(() => {
